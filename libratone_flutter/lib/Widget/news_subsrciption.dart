      ...
      child: new Stack(
        children: <Widget>[
          ...
          Align(
            ...
            child:
                Text(Translations.of(context).text('news_subscription_title'),
                    style: TextStyle(
                      fontSize: 18.0,
          ...
          children: <Widget>[
            new Container(
              ...
              child: RaisedButton(
                ...
                color: Color(0xFF4A4A4A),
                child: Text(Translations.of(context).text('news_subscribe'),
                    style: TextStyle(
                      fontSize: 18.0,
                      color: Colors.white,
                    )),
            ...
            new Container(
              ...
              child: FlatButton(
                ...
                child: Text(Translations.of(context).text('news_unsubscribe'),
                    style: TextStyle(
                      fontSize: 12.0,
              ...
              new Container(
                child: Text(
                    Translations.of(context)
                        .text('news_subscription_illustration'),
                    style: TextStyle(
                      fontSize: 16.0,
                      color: Color(0XFF4A4A4A),
                    )),
